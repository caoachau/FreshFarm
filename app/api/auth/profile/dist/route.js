...
function PATCH(request) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, _a, name, phone, updateData, user, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), name = _a.name, phone = _a.phone;
                    updateData = {};
                    if (name !== undefined) {
                ...
                case 2:
                    user = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json(__assign(__assign({}, user), { name: user.fullName }))];
                case 3:
                    error_1 = _b.sent();
