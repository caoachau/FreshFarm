...
function SignupPage() {
    ...
    var _d = react_1.useState(false), agreeTerms = _d[0], setAgreeTerms = _d[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    data = _a.sent();
                    if (!res.ok) {
                        setError((data === null || data === void 0 ? void 0 : data.error) || "Đăng ký thất bại");
                        return [2 /*return*/];
                    }
        ...
        react_1["default"].createElement("div", { className: "w-full max-w-md" },
            react_1["default"].createElement("div", { className: "bg-white rounded-2xl shadow-xl overflow-hidden" },
                react_1["default"].createElement("div", { className: "bg-white text-black" },
                    ...
                    react_1["default"].createElement("h4", { className: "text-xl font-bold text-center mb-2" }, "\u0110\u0103ng K\u00FD"),
                    react_1["default"].createElement("p", { className: "text-center text-gray-500 text-sm" }, "T\u1EA1o t\u00E0i kho\u1EA3n m\u1EDBi c\u1EE7a b\u1EA1n")),
                react_1["default"].createElement("div", { className: "p-8" },
                    error && (react_1["default"].createElement("div", { className: "mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg text-sm flex items-start gap-2" },
                    ...
                    react_1["default"].createElement("form", { onSubmit: handleSubmit, className: "space-y-4" },
                        react_1["default"].createElement("div", null,
                            react_1["default"].createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "H\u1ECD v\u00E0 t\u00EAn"),
                            react_1["default"].createElement("div", { className: "relative" },
                                react_1["default"].createElement(lucide_react_1.User, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" }),
                                react_1["default"].createElement("input", { type: "text", name: "name", value: formData.name, onChange: handleChange, placeholder: "Nguy\u1EC5n V\u0103n A", className: "w-full pl-11 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition" }))),
                        react_1["default"].createElement("div", null,
                        ...
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement("p", { className: "mt-1 text-xs text-gray-500" }, "T\u1ED1i thi\u1EC3u 6 k\u00FD t\u1EF1")),
                        react_1["default"].createElement("div", null,
                            react_1["default"].createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "X\u00E1c nh\u1EADn m\u1EADt kh\u1EA9u"),
                            react_1["default"].createElement("div", { className: "relative" },
                                react_1["default"].createElement(lucide_react_1.Lock, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" }),
                                react_1["default"].createElement("input", { type: showConfirmPassword ? "text" : "password", name: "confirmPassword", value: formData.confirmPassword, onChange: handleChange, placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", className: "w-full pl-11 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition" }),
                                react_1["default"].createElement("button", { type: "button", onClick: function () { return setShowConfirmPassword(!showConfirmPassword); }, className: "absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition" }, showConfirmPassword ? react_1["default"].createElement(lucide_react_1.EyeOff, { className: "w-5 h-5" }) : react_1["default"].createElement(lucide_react_1.Eye, { className: "w-5 h-5" })))),
                        react_1["default"].createElement("label", { className: "flex items-start gap-3 cursor-pointer" },
                            react_1["default"].createElement("input", { type: "checkbox", checked: agreeTerms, onChange: function (e) { return setAgreeTerms(e.target.checked); }, className: "w-5 h-5 mt-0.5 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500 cursor-pointer" }),
                            react_1["default"].createElement("span", { className: "text-sm text-gray-600" },
                                "T\u00F4i \u0111\u1ED3ng \u00FD v\u1EDBi",
                                " ",
                                react_1["default"].createElement("a", { href: "/terms/", className: "text-emerald-600 hover:text-emerald-700 font-medium transition" }, "\u0110i\u1EC1u kho\u1EA3n d\u1ECBch v\u1EE5"),
                                " ",
                                "v\u00E0",
                                " ",
                                react_1["default"].createElement("a", { href: "/privacy/", className: "text-emerald-600 hover:text-emerald-700 font-medium transition" }, "Ch\u00EDnh s\u00E1ch b\u1EA3o m\u1EADt"))),
                        react_1["default"].createElement("button", { type: "submit", disabled: isLoading, className: "w-full bg-gradient-to-r from-emerald-500 to-green-600 text-white py-3 rounded-lg font-medium hover:from-emerald-600 hover:to-green-700 transition shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed mt-2" }, isLoading ? "Đang xử lý..." : "Đăng Ký")),
                    react_1["default"].createElement("p", { className: "text-center mt-6 text-sm text-gray-600" },
                        "\u0110\u00E3 c\u00F3 t\u00E0i kho\u1EA3n?",
                        " ",
                        react_1["default"].createElement("a", { href: "/auth/login", className: "text-emerald-600 hover:text-emerald-700 font-semibold transition" }, "\u0110\u0103ng nh\u1EADp ngay")))),
