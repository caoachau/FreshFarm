...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var users, fixedCount, _i, users_1, user, password, isPlainText, hashedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    isPlainText = !password || password.length < 60 || !password.startsWith('$2');
                    if (!isPlainText) return [3 /*break*/, 5];
                    console.log("Fixing password for user: " + user.email);
                    return [4 /*yield*/, auth_1.hashPassword(password || 'default123')
                        // Update using raw query
                    ];
                case 3:
                    hashedPassword = _a.sent();
                    // Update using raw query
                    return [4 /*yield*/, db_1.prisma.user.updateManyRaw({
                            filter: { _id: user._id },
